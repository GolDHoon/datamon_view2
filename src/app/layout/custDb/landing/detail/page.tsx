                ...
                return (
                    <div className="duplication">
                                ...
                                return (
                                    <li key={index}>
                                        <span onDoubleClick={(event) => {
                                            // @ts-ignore
                                            setDuplData({keyGroup:dupl.keyGroup, duplColumn:dupl.infoList, preprocessing:dupl.prePrc, postprocessing:dupl.postPrc})
                                            setDuplModalOpen("M");
                                        }}>{combinedInfo}</span>
                                    </li>
                                );
                        ...
                        <div className="btn_box">
                            <button type="button" className="type1" onClick={(event)=>setDuplModalOpen("C")}>신규</button>
                        </div>
                    </div>
                );
            case "IP차단":
                    ...
                    <div className="modal_wrap copy_ver2">
                        ...
                        <div className="modal_body">
                            <div className="left">
                                ...
                                <ul>
                                    {keyList.map((key, index) => (
                                        <li key={index}>
                                            <input type="checkbox" name="duplKey" value={key} checked={duplData.duplColumn.includes(key)}
                                            onChange={(event) => {
                                                const { value, checked } = event.target;
                                                setDuplData((prevState:any) => {
                                                    const duplColumn = checked
                                                        ? [...prevState.duplColumn, value]
                                                        : prevState.duplColumn.filter((item:any) => item !== value);
                            ...
                            <div className="right">
                                ...
                                <ul>
                                    <li>
                                        <input type="checkbox" name="preprocessing" value="preprocessing" checked={duplData.preprocessing}
                                    ...
                                    <li>
                                        <input type="checkbox" name="postprocessing" value="postprocessing" checked={duplData.postprocessing}
                                               onChange={(event) => setDuplData({
                                                   ...duplData,
                                                   [event.target.name]: event.target.checked,
                                               })}/>
                        ...
                        <div className="modal_foot">
                            <div className="btn_box">
                                {duplModalOpen === "M" && (
                                    <>
                                        <button type="button" className="type1" onClick={(event) => handleDuplCheckModify()}>수정</button>
                                        <button type="button" className="type3" onClick={(event) => handleDuplCheckDelete()}>삭제</button>
                                    </>
                                )}
                                {duplModalOpen === "C" && (
                                    <button type="button" className="type1" onClick={(event) => {handleDuplCheckCreate()}}>생성</button>
                                )}
                            </div>
                        </div>
                    </div>
