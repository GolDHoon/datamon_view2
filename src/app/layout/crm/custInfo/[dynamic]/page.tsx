...
import Modal from "../../../../components/layout/crm/custInfo/Modal";
...
const Page : React.FC<PageProps> = ({params}) => {
    ...
    const getDataList = () => {
        try {
            restApi('get','/custInfo/list',{
                custDBType: selectedDbType,custDBCode: selectedDb,
            }).then(response => {
                // @ts-ignore
    ...
    useEffect(() => {
        ...
        if (!["USTY_DEVL","USTY_CRAC"].includes(getSession("userType") as string)) {
            router.push('/home');
        }
