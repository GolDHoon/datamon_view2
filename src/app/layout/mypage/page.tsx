...
const Page : React.FC<PageProps> = () => {
    ...
    const [userInfo,setUserInfo] = useState<{
        ...
        userId: "",name: "",role: "",mail: "",tel: "",ceo: "",brn: "",address: "",bizStatus: "",bizKind: "",
    })
            ...
            restApi('get','/member/',{}).then(response => {
                ...
                if (response.status === 200) {
                    setUserInfo({
                        ...
                        mail: response.data.contactMail,
                        tel: response.data.contactPhone
                    })
                }
            })
        } catch (e) {
    ...
    return (<CommonLayout>
            <div className="mypage_wrap">
                ...
                {userKind !== "" && (<>
                    {userKind === "member" && (<div className="name">
                    ...
                    <section className="user_content">
                                ...
                                <li>
                                    ...
                                    <div>
                                        <input type="text" disabled={true} value={userInfo.mail}
                                               onChange={(event) => setUserInfo({
                                                   ...userInfo,mail: event.target.value
                                               })}/>
                                ...
                                {userKind === "member" && (<li>
                                    ...
                                    <div>
                                        <input type="text" disabled={true} value={userInfo.tel}
                                               onChange={(event) => setUserInfo({
                                                   ...userInfo,tel: event.target.value
                                               })}/>
                                        <button type="button" className={"check"}>인증요청</button>
                                    </div>
                                </li>)}
                        ...
                        <div>
                            ...
                            {userKind === "admin" && (<ul>
                                <li>
                                    <label htmlFor="">사&nbsp;&nbsp;업&nbsp;&nbsp;자<br/>등록번호</label><input
                                    type="text"
                                    value={userInfo.brn}
                                    onChange={(event) => setUserInfo({
                                        ...userInfo,brn: event.target.value
                                    })}/>
                                </li>
                                <li>
                                    <label htmlFor="">업&nbsp;&nbsp;체&nbsp;&nbsp;명</label><input type="text"
                                                                                                value={userInfo.name}
                                                                                                onChange={(event) => setUserInfo({
                                                                                                    ...userInfo,
                                ...
                                <li>
                                    <label htmlFor="">업&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;태</label><input
                                    type="text"
                                    value={userInfo.bizStatus}
                                    onChange={(event) => setUserInfo({
                                        ...userInfo,bizStatus: event.target.value
                                    })}/>
                                </li>
                                <li>
                                    <label htmlFor="">업&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;종</label><input
                                    type="text"
                                    value={userInfo.bizKind}
                                    onChange={(event) => setUserInfo({
                                        ...userInfo,bizKind: event.target.value
                                    })}/>
                                </li>
                            </ul>)}
                            <div className={"btn_box"}>
                                <button type="button" className="type1" onClick={(evnet) => handleModify()}>수정
                                </button>
                                <button type="button" className="type3" onClick={(evnet) => handleDelete()}>회원탈퇴
                                </button>
                            </div>
                        </div>
                    </section>
